      ...
      <div className="container mx-auto px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="font-serif text-3xl font-bold text-white md:text-4xl lg:text-5xl text-balance">
            Go Solo, <span className="text-brand-coral">Together</span>
          </h2>
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link
              href="/signup"
              className="inline-flex items-center gap-2 rounded-full bg-brand-coral px-8 py-3 text-sm font-semibold text-white transition-all hover:bg-brand-coral/90 hover:shadow-lg"
            >
