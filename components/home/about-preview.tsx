    ...
    <section ref={sectionRef} className="relative overflow-hidden bg-white py-24">
      ...
      <div className="container relative mx-auto px-6">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          {/* Image with parallax */}
          <div ref={imageRef} className="relative h-[400px] overflow-hidden rounded-2xl border-2 border-[#0439D9]/20 lg:h-[500px]">
          ...
          <div className="flex flex-col gap-6">
            ...
            <Link href="/about" className="mt-4">
              <Button className="group gap-2 rounded-full bg-[#0439D9] px-6 text-white transition-all hover:bg-[#034AA6] hover:shadow-lg">
                Read My Story
