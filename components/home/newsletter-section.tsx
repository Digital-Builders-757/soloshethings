    ...
    <section className="relative bg-[#2044e0] py-16 md:py-24">
      ...
      <div className="relative z-10 mx-auto max-w-[1240px] px-5 text-center md:px-8">
        <h2 className="text-2xl font-bold text-white md:text-[2rem]">
          Stay in the <span className="italic text-[#ffd0a9]">Loop</span>
        </h2>
        ...
        >
          ...
          <button
            ...
            className="rounded-full bg-white px-6 py-3 font-semibold text-[#df4915] transition-all hover:bg-white/90 disabled:opacity-70 sm:rounded-l-none"
          >
            {status === "loading"
              ? "..."
              : status === "success"
