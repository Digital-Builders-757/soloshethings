              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:gap-0">
                <div className="relative flex-1">
                  ...
                  <Input
                    ...
                    required
                    className="h-14 rounded-full border-2 border-white/40 bg-white/15 pl-12 pr-4 text-white placeholder:text-white/60 backdrop-blur-sm focus:border-white focus:bg-white/25 sm:rounded-r-none"
                  />
                </div>
                <Button
                  type="submit"
                  disabled={status === "loading"}
                  className="h-14 gap-2 rounded-full bg-[#034AA6] px-8 text-white transition-all hover:bg-[#021a4d] hover:shadow-lg sm:rounded-l-none"
                >
                  {status === "loading" ? (
                    <>
