    ...
    <main className="min-h-screen px-4 py-16">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="surface-card rounded-xl p-8">
          <h1 className="text-3xl font-bold mb-6 text-brand-navy">Edit Profile</h1>
          ...
          <form action={formAction} className="space-y-6">
            ...
            <div className="flex gap-4">
              <button
                type="submit"
                className="flex-1 bg-brand-coral text-white px-8 py-3 rounded-full font-semibold hover:bg-brand-coral/90 transition-all active:scale-[0.98]"
              >
                Save Changes
              </button>
              <Link
