/**
 * Blog Post Detail Page (Protected - requires authentication)
 * 
      ...
      <main className="min-h-screen py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <nav className="mt-16 pt-8 border-t border-neutral-200">
            <Link
              href="/blog"
              className="text-[#0439D9] hover:text-[#034AA6] font-medium transition-colors inline-flex items-center gap-2"
            >
              ← Back to Blog
            </Link>
          </nav>
